...
public class Mappers {
    public static final ComponentMapper<ChunkPosition> chunkPositionMpr = ComponentMapper.getFor(ChunkPosition.class);
    public static final ComponentMapper<CollisionBox> collisionBoxMpr = ComponentMapper.getFor(CollisionBox.class);
    public static final ComponentMapper<ExactPosition> exactPositionMpr = ComponentMapper.getFor(ExactPosition.class);
